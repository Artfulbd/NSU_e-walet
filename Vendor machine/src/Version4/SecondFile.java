...
public class SecondFile extends JFrame {
	...
	private void InvalidMsgViewer() {
		...
		lblYourServiceIs.setBounds(161, 206, 1038, 79);
		...
		lblPleaseContactTo.setBounds(234, 317, 894, 79);
		...
		if(IdValidator.isConnected()) {
			lblYourServiceIs.setText("Your service is blocked.");
			lblPleaseContactTo.setText("Please contact to IT.");	
		}
		else {
			lblYourServiceIs.setText("Problen on server handshake!");
			lblPleaseContactTo.setText("Please check contaction.");
		}
	...
	private void paymentStatusViewer(PurchaseController pc) {
		...
		JLabel lblTranctionSuccessfullYou = new JLabel(pc.getApires());
		...
		lblTranctionSuccessfullYou.setBounds(173, 136, 601, 64);
		...
		lblYouCanCheck.setBounds(62, 332, 530, 40);
		...
		lblOnYourRds.setBounds(62, 382, 331, 40);
