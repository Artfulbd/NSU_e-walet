                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group ">
                                                <input type="text" name="name" maxlength="10" class="form-control"
                                                    placeholder="Please enter your username" id="UserName" autofocus
                                                    >
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group ">
                                                <input type="password" name="pass" class="form-control"
                                                    placeholder="Please enter your password" id="password" autofocus
                                                    >
                                                <i class="fa fa-user"></i>
            ...
            <div class="footer">
                <div class="footer-inner">
                    <div class="footer-content">
                        <span class="blue">Developed &amp; Maintained By Full OF_BUGS</span>
               </div>
                </div>
            </div>
        </div>
